...
gui
  ...
  .step(1)
  .name("lightIntensity");
gui.add(directionalLight.position, "x").min(-10).max(10).step(1).name("lightX");
gui.add(directionalLight.position, "y").min(-10).max(10).step(1).name("lightY");
gui.add(directionalLight.position, "z").min(-10).max(10).step(1).name("lightZ");
...
gltfLoader.load("/models/hamburgerGerardo.glb", (gltf) => {
