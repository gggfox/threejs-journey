...
const gltfLoader = new GLTFLoader(); // we arent using DRACO compression
...
// much more heavier to load and render
...
// LDR equirectangular
// const environmentMap = textureLoader.load("/environmentMaps/cyberpunk.jpeg");
...
const holyDonut = new THREE.Mesh(
  ...
  new THREE.MeshBasicMaterial({ color: new THREE.Color(10, 4, 10) })
);
