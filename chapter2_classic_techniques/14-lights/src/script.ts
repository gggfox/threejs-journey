...
if (light === Light.rectArea) {
    const rectAreaLight = new THREE.RectAreaLight(0x4e00ff, 50, 1, 1)
    rectAreaLight.position.set(0,2,3)
    rectAreaLight.lookAt(new THREE.Vector3())
    scene.add(rectAreaLight)

    const rectAreaLightHelper = new RectAreaLightHelper(rectAreaLight, 0x4e00ff)
