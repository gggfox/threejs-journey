...
gui.add(parameters,'animated').onFinishChange(generateGalaxy)
gui.add(parameters, 'animationSpeed').min(0).max(10).step(0.001).onFinishChange(generateGalaxy)
