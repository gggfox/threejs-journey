...
// Post Processing
// Render Target, used for antti0-aliasing
...
const FuturisticShader = {
  ...
  fragmentShader: `
    ...
    void main() {
      ...
      vec4 color = texture2D(tDiffuse, vUv + normalColor.xy * 0.1);
...
futuristicPass.enabled = true;
effectComposer.addPass(futuristicPass);

// Antialiasing for old browsers
...
gui.add(futuristicPass, "enabled").name("FuturisticPass");
